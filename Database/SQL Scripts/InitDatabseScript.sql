...
CREATE UNIQUE INDEX UX_ORDER_TYPES_NAME
ON ORDER_TYPES
(
	[NAME]
)
...
CREATE OR ALTER PROCEDURE dbo.SP_REINIT_COUNTER
(
	@COUNTER_NAME			AS NVARCHAR(128),
