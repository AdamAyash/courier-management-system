module bg.tu_varna.sit.couriermanagementsystem {
    ...
    opens bg.tu_varna.sit.couriermanagementsystem.controllers.notifications to  javafx.fxml;
    ...
    opens bg.tu_varna.sit.couriermanagementsystem.domainobjects.notifications to javafx.base;
    opens bg.tu_varna.sit.couriermanagementsystem.controllers.common to  javafx.fxml;
